<template>
  <div v-if="isMounted">
    ...
    <div class="w-full h-screen bg-center bg-cover hero-bg-img">
      <div class="absolute w-full h-screen bg-black bg-opacity-50"></div>
      <div class="absolute w-full h-screen p-4 md:p-12">
        <div class="flex flex-col items-center justify-center w-full h-full border-white border-12 md:border-24">
          <h1
            class="font-sans text-6xl tracking-wider text-white md:text-7xl lg:font-bold"
          ...
          <div class="w-full mt-8">
            <ul class="flex justify-center">
              <li>
                <a href="https://www.facebook.com/izumi.love.kagoshima" target="_blank" rel="noopener" aria-label="イズミラヴのFacebookページ">
                  <svg class="w-12 h-12 text-white fill-current lg:w-16 lg:h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <li>
                <a href="https://twitter.com/_izumi_love" target="_blank" rel="noopener" aria-label="イズミラヴのTwitter">
                  <svg class="w-12 h-12 text-white fill-current lg:w-16 lg:h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
