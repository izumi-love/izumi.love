      ...
      <ul class="flex justify-center">
        <li>
          <a href="https://www.facebook.com/izumi.love.kagoshima" target="_blank" rel="noopener">
            <svg class="w-12 h-12 lg:w-16 lg:h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<style scoped>
.container {
  @apply min-h-screen flex justify-center items-center text-center mx-auto flex-col;
}
